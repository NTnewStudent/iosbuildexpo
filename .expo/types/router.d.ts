...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/` | `/(tabs)` | `/(tabs)/record` | `/record` | `/(tabs)/setting` | `/setting` | `/(tabs)/test` | `/test` | `/+html` | `/.DS_Store` | `/boot/` | `/buy/` | `/modal` | `/user/memo/backup` | `/user/memo/` | `/user/register/` | `/user/userinfo/`;
  // prettier-ignore
